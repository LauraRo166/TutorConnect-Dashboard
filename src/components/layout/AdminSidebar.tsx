...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-60 flex flex-col bg-[#005862] transition-transform duration-300 ease-in-out
      ...
      >
        ...
        <div className="flex h-16 items-center gap-3 px-5">
          ...
          <button
            onClick={close}
            className="md:hidden h-8 w-8 flex items-center justify-center rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
